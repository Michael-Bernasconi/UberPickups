...
\usepackage[a4paper,top=2cm,bottom=2cm,left=2cm,right=2cm]{geometry} %impaginazione e margini documento
...
\usepackage{tabularx}  % Mettere nel preambolo
...
\input{Capitoli/Methods and Algorithms}
\input{Capitoli/Data Description}
\input{Capitoli/Data Exploration}
\input{Capitoli/Modeling and Results.tex}
